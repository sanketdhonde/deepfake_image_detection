...
# 2. Load trained DenseNet121 model and weights
model_path = "best_model_densenet.pth"
...
class GradCAM:
    ...
    def generate(self, input_tensor):
        ...
        # SAFELY BACKWARD WITH MATCHING SHAPE
...
# 6. Layers to visualize (All key DenseNet121 layers)
layer_dict = {
    ...
    "denseblock4": model.features.denseblock4  # last safe & most informative layer
}

# 7. Main
if __name__ == "__main__":
    img_path = "/home/user/Deepfake/ExternalTest/df1.jpg"
