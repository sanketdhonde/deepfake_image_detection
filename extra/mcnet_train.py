...
def train_model(model, train_loader, val_loader, criterion, optimizer, scheduler, num_epochs=200, device='cuda:1'):
    best_acc = 0.0
    start_epoch = 0
    checkpoint_path = 'mcnet_checkpoint.pth'
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if val_acc > best_acc:
            best_acc = val_acc
            torch.save(model.state_dict(), 'best_mcnet.pth')
